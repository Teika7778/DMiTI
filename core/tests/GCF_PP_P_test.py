...
class GCF_PP_P_test(unittest.TestCase):
    ...
    def test_GCF(self):
        zero_coef_1 = Rational(Integer(Natural([5]), False), Natural([1])) # -5
        first_coef_1 = Rational(Integer(Natural([8])), Natural([1])) # 8
        second_coef_1 = Rational(Integer(Natural([3]), False), Natural([1])) # -3
        third_coef_1 = Rational(Integer(Natural([4]), False), Natural([1])) # -4
        forth_coef_1 = Rational(Integer(Natural([2])), Natural([1])) # 2
        fifth_coef_1 = Rational(Integer(Natural([0])), Natural([1])) # 2
        sixth_coef_1 = Rational(Integer(Natural([1])), Natural([1])) # 2
        ...
        first_coef_2 = Rational(Integer(Natural([1]), False), Natural([1])) # -1
        ...
        #1-x+x^3
        correct_answer = Polynomial([Rational(Integer(Natural([9, 2])), Natural([4])), 
                                     Rational(Integer(Natural([9, 2]), False), Natural([4])), 
                                     Rational(Integer(Natural([0])), Natural([1])), 
                                     Rational(Integer(Natural([9, 2])), Natural([4]))])
        self.assertEqual([str(elem) for elem in result.coefficients], [str(elem) for elem in correct_answer.coefficients])

    def test_GCF_2(self):
        zero_coef_1 = Rational(Integer(Natural([1]), False), Natural([1])) # -1
        first_coef_1 = Rational(Integer(Natural([4]), False), Natural([1])) # -4
        second_coef_1 = Rational(Integer(Natural([3]), False), Natural([1])) # -3
        ...
        zero_coef_2 = Rational(Integer(Natural([1]), False), Natural([1])) # -1
        first_coef_2 = Rational(Integer(Natural([1]), False), Natural([1])) # -1
        second_coef_2 = Rational(Integer(Natural([1])), Natural([1])) # 1
        ...
        result = self.gcf_module.execute([first_polym, second_polym])[0]
        #-x-1
        correct_answer = Polynomial([Rational(Integer(Natural([3]), False), Natural([4])), 
                                     Rational(Integer(Natural([3]), False), Natural([4]))])
        self.assertEqual([str(elem) for elem in result.coefficients], [str(elem) for elem in correct_answer.coefficients])
